...
file_type = FileType::UNKNOWN;
   ...
   //nothing to do here
	   ...
	   int err = WSAStartup(WSVERS, &wsadata);
         ...
         printf("\n        REDO w/A1-START-UP-cross_platform.cpp\n");
		 printf("\n============================================\n");
		 printf("    submitted by: Greshka LAO, Any KWOK");
         printf("\n           date:     15/04/24");
		 printf("\n============================================\n");
	
		 
		 memset(&localaddr,0,sizeof(localaddr));//clean up the structure  - initializes to 0
		 memset(&remoteaddr,0,sizeof(remoteaddr));//clean up the structure - initializes to 0
...
//********************************************************************
		 ...
		 if (argc == 2) {
             ...
             // In our lectures, we have an elegant way of resolving the local address and port to be used by the server.
